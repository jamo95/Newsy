...
#article4 = hackernoon.ArticleLoader.load(
#'https://hackernoon.com/how-it-feels-to-learn-javascript-in-2016-d3a717dd577f'
#)
#print (article4['title'])


#article5 = newsau.ArticleLoader.load(
#'http://www.news.com.au/entertainment/celebrity-life/celebrities-gone-bad/as-movie-mogul-heads-to-sex-rehab-police-and-fbi-tipped-to-investigate/news-story/3443e313c1e08e90658689d728d01b56')

#print(article5['title'])
