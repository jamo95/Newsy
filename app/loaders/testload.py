...
#article2 = cricketau.ArticleLoader.load('http://www.cricket.com.au/news/updated-big-bash-league-bbl07-squads-each-club-playing-list-ins-and-outs/2017-10-17')
#print(article2['date'])
#
#
